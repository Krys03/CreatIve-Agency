...
function ShowreelReveal() {
  return (
    <section className="showreel-reveal showreel-dark grid-bg relative border-b border-line">
      <div className="relative flex items-start overflow-hidden py-8">
        <div className="grid-layout absolute inset-x-0 top-8 z-10 grid grid-cols-4 items-start md:grid-cols-12">
          <motion.div
            variants={fadeUp}
            initial="hidden"
            whileInView="show"
